<?php echo $__env->make('includes.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<section class="ptb60 darkSection minHeightFull">
		<div class="container">
						...
						<?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="form-group col-md-12 row">
								<div class="choseFileFiled col-md-4">
									<label class="lebelBtn"><?php echo e($item->detail_item); ?></label>
								</div>
								<div class="choseFileFiled col-md-4"style="margin-left:15px">
									<label class="lebelBtn"><?php echo e($item->detail_item_ara); ?></label>
								</div>
								
								<div class="col-md-2" style="padding:20px; " >
									<!-- <a href="javascript:edit_product_detail(<?php echo e($item->id); ?>,'<?php echo e($item->detail_item); ?>')"style="display:inline-text"><h3><img src="<?php echo e(URL::asset('assets/front/images/save.png')); ?>" style="width: 50px; height: 50px;"></h3></a>  -->
			...
			<a href="<?php echo e(url('edit_profile')); ?>" style="float:right"><button type="button" class="btn btn-primary" >Return</button></a>
		</div>
	</section>
	
<?php echo $__env->make('includes.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<form class="deletform" action="<?php echo e(url('delete_product_detail')); ?>"method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
$(document).ready(function() {
	...
	function add_detail(){
		...
		if($("#detail_name").val()==''&& $("#detail_name_ara").val()==''){
			...
			$.ajax({
	            type : "POST",
	            url: "<?php echo e(url('insert_product_details')); ?>",
	            data : {
            	...
            	$('.file-field').append('<div class="form-group col-md-12 row">\n' +
											...
											'\t\t\t\t\t\t\t\t\t	</div>\n' +
											'\t\t\t\t\t\t\t\t\t	<div class="col-md-2 ; " style="padding:20px; " >\n' +
											// '\t\t\t\t\t\t\t\t\t     <a href="javascript:edit_product_detail('+detail_id+','+$("#detail_name").val()+')"style="display:inline-text"><h3><img src="<?php echo e(URL::asset('assets/front/images/save.png')); ?>" style="width: 50px; height: 50px;"></h3></a>\n' +
