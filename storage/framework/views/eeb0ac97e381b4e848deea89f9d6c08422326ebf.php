<?php echo $__env->make('includes.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		...
		<div id="demo" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="<?php echo e(URL::asset('assets/front/images/slider01.jpg')); ?>" alt="Slider">
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 col-sm-8 offset-lg-2 offset-sm-2 ourservicesTop80 ourServicesGraphics">
					...
					<img src="<?php echo e(URL::asset('assets/front/images/our-services.jpg')); ?>">
	...
	<section class="ptb50 darkSection">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-sm-12">
					<h3 class="sectionicon"><img src="<?php echo e(URL::asset('assets/front/images/getCertificationicon.png')); ?>"></h3>
				...
				<div class="col-lg-8 col-sm-8 offset-lg-2 offset-sm-2 ourservicesTop80 ourServicesGraphics">
					<img src="<?php echo e(URL::asset('assets/front/images/get-certificate-timeline.png')); ?>">
				</div>
			</div>
		</div>
	</section>
	<section class="ptb50 globalSection">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-sm-6">
					<img src="<?php echo e(URL::asset('assets/front/images/map.png')); ?>" class="mobileView">
