                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="" style="padding:25px;">
                                ...
                                <a href="<?php echo e(url('admin/employees')); ?>"><button type="button" class="btn btn-outline-primary waves-effect waves-light"  style="display:inline-block; float:right;"><i class="mdi mdi-format-list-bulleted"></i>&nbsp;  List</button>
                                </a>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <input type="number" class="form-control col-sm-7 input" data-parsley-type="number" name="phone"  placeholder="Phone Number" value="<?php echo isset($user)? $user[0]->phone:old('phone'); ?>" required/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
