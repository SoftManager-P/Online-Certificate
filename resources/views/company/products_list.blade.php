                ...
                <!-- offset-lg-2 -->
                    <div class="payfeesSection">
                        <div class="payfeesRow submittedRow">
                            ...
                            <div>
                                <a href="{{url('edit_product')}}/0"><button class="btn " >New Product</button></a>
                            </div>
                            <div>
                            ...
                            <div>
                                <a href="{{url('submit_product')}}"><button class="btn "> Submit</button></a>
                            </div>
            ...
            <div class="row " style="padding-top:20px">
                ...
                <table class="rwd-table  dt-responsive table table-hover mb-0" >
                    ...
                    <tr class="">
                        ...
                        <td data-th="print">
                            <a href="{{url('edit_product')}}/{{$item1['id']}}" style="display:inline-text"><img src="{{ URL::asset('assets/front/images/save.png')}}" style="width: 40px; height: 40px;"></a> 
...
<form id="print_form" method="POST" action="{{url('delete_product')}}">
    @csrf
...
<div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="" action="{{url('set_category')}}" autocomplete="on" method="post" enctype="multipart/form-data">
            @csrf
...
<div class="modal fade bs-example-modal-center-a" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="" action="{{url('uploadCsvFile')}}" autocomplete="on" method="post" enctype="multipart/form-data">
            @csrf
            <div style="text-align:center"><a href="{{url('template_excel')}}" ><span >template download</span></a></div>
            <div class="modal-body">
