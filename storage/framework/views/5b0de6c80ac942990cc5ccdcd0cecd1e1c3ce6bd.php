                ...
                <!-- offset-lg-2 -->
                    <div class="payfeesSection">
                        <div class="payfeesRow submittedRow">
                            ...
                            <div>
                                <a href="<?php echo e(url('edit_service')); ?>/0"><button class="btn " >New Service</button></a>
                            </div>
                            <div>
                                <button class="btn " style="background-color:#58c358;border-color:#58c358;"  onclick="set_category()" >Set Ctegory</button>
                            </div>
                            <div>
                                <a href="<?php echo e(url('submit_service')); ?>"><button class="btn "> Submit</button></a>
                            </div>
                            <div>
            ...
            <div class="row " style="padding-top:20px">
                ...
                <table class="rwd-table  dt-responsive table table-hover mb-0" >
                    ...
                    <tr>
                        ...
                        <th><?php echo e($item->service_detail); ?></th>
                    ...
                    <tbody >
                    <?php $__currentLoopData = $service_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $item1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="">
                        ...
                        <td data-th="print">
                            <a href="<?php echo e(url('edit_service')); ?>/<?php echo e($item1['id']); ?>" style="display:inline-text"><img src="<?php echo e(URL::asset('assets/front/images/save.png')); ?>" style="width: 40px; height: 40px;"></a> 
...
<form id="print_form" method="POST" action="<?php echo e(url('delete_service')); ?>">
    <?php echo csrf_field(); ?>
...
<div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="" action="<?php echo e(url('set_category_cus')); ?>" autocomplete="on" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
