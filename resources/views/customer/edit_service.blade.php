                ...
                <!-- offset-lg-2 -->
                    <div class="payfeesSection">
                        ...
                        <div class="submittedDocTable">
                            <form class="" action="{{url('save_service')}}" autocomplete="on" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="form-group row" >
                                    ...
                                    <input type="text" class="cardinput col-md-3 offset-md-1" name="product_name" placeholder="name"  value="{{!empty($product)?$product['name_e']:old('product_name')}}" required>
                                    <input type="text" class="cardinput col-md-3 offset-md-1" name="product_name_ara" placeholder="name_ara"  value="{{!empty($product)?$product['name_a']:old('product_name')}}" required>
                                </div>
                                @foreach($detail as $key3 =>$item3)
                                    <div class="form-group row" >
                                        <label class="col-md-2" style="text-align:right"><h5> {{$item3->service_detail}}</h5></label>
                                ...
                                <div class="form-group row" >
                                    ...
                                    <input type="file" class="cardinput" style="opacity:0" name="document" placeholder="document" id="document" onchange="preview(this);" {{!empty($product['document'])?'':'required'}}>
