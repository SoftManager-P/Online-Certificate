                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="" style="padding:25px;">
                                ...
                                <a href="<?php echo e(url('admin/editsector/0')); ?>"><button type="button" class="btn btn-outline-primary waves-effect waves-light"  style="display:inline-block; float:right;"><i class="mdi mdi-table-edit"></i>&nbsp;New</button>
                                </a>
                            </div>
...
<script>
    ...
    function user_delete(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo e(url('admin/delete_sector')); ?>",
                    type: 'POST',
                    data: {id:id},
                    headers: {
    ...
    $(document).ready(function() {
        ...
        var datatable = $table.dataTable({
            ...
            "ajax": {
                "type": "POST",
                "async": true,
                "url": '<?php echo e(url("/admin/sectorlist")); ?>',
                "data": {},
                "dataSrc": "data",
                "dataType": "json",
                "cache": false,
            ...
            "columnDefs":[
            {
                ...
                "createdCell": function (td, cellData, rowData, row, col) {
                    var id = ''+cellData+'';
                    html = '<a href="<?php echo e(url('admin/editsector/')); ?>/'+cellData+'"><input class="btn btn-info" type="button" value="Edit"></a> <input class="btn btn-danger" type="button" value="Delete" onclick="user_delete('+cellData+')">'
                    $(td).html(html);
                }
            }],
