                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="" style="padding:25px;">
                                ...
                                <a href="{{url('admin/customers')}}"><button type="button" class="btn btn-outline-primary waves-effect waves-light"  style="display:inline-block; float:right;"><i class="mdi mdi-format-list-bulleted"></i>&nbsp;  List</button>
                                </a>
                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <input type="text" class="form-control col-sm-7" name="company_name" required placeholder="Company Name" value="{!! isset($user)? $user[0]->company_name:old('company_name') !!}"/>
                                                    </div>
                                                    <div class="form-group row" >
