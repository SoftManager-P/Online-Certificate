<footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12 ftrTop">
                    ...
                    <a href="{{url('register')}}" class="newsBTN">Sign up <i class="fas fa-chevron-right"></i></a>
                    @endif
                </div>
                <div class="col-lg-4 col-md-4 ftrLogo">
                    <img src="{{ URL::asset('assets/front/images/footerlogo.png')}}">
                </div>
    ...
    <!-- // <script src="{{ URL::asset('assets/front/js/fontawesome.js')}}"></script> -->
    <script src="{{ URL::asset('assets/front/js/jquery.fancybox.min.js')}}"></script>
    <script src="{{ URL::asset('assets/front/js/owl.carousel.js')}}"></script>
    <script src="{{ URL::asset('assets/front/js/wow.min.js')}}"></script>
    <script src="{{ URL::asset('assets/front/js/sticky_script.js')}}"></script>
